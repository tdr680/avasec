<div class="entities index">
	...
	<tr>
		...
		<td><?php echo h($entity['EntityWfc']['extid']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $entity['EntityWfc']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $entity['EntityWfc']['id']), null, __('Are you sure you want to delete # %s?', $entity['EntityWfc']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
